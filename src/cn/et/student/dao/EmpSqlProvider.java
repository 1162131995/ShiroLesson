...
import cn.et.student.entity.EmpExample.Criterion;
...
public class EmpSqlProvider {
    ...
    public String insertSelective(Emp record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("SCOTT.EMP");
        
        if (record.getEid() != null) {
            sql.VALUES("EID", "#{eid,jdbcType=DECIMAL}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getEid() != null) {
            sql.SET("EID = #{record.eid,jdbcType=DECIMAL}");
        }
    ...
    public String updateByPrimaryKeySelective(Emp record) {
        ...
        if (record.getDeptid() != null) {
            sql.SET("DEPTID = #{deptid,jdbcType=DECIMAL}");
        }
        
        sql.WHERE("EID = #{eid,jdbcType=DECIMAL}");
