...
import cn.et.student.entity.DeptExample.Criterion;
...
public class DeptSqlProvider {
    ...
    public String insertSelective(Dept record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("SCOTT.DEPT");
        
        if (record.getDeptid() != null) {
            sql.VALUES("DEPTID", "#{deptid,jdbcType=DECIMAL}");
        }
        ...
        if (record.getPid() != null) {
            sql.VALUES("PID", "#{pid,jdbcType=DECIMAL}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getDeptid() != null) {
            sql.SET("DEPTID = #{record.deptid,jdbcType=DECIMAL}");
        }
        ...
        if (record.getPid() != null) {
            sql.SET("PID = #{record.pid,jdbcType=DECIMAL}");
        }
    ...
    public String updateByPrimaryKeySelective(Dept record) {
        ...
        if (record.getPid() != null) {
            sql.SET("PID = #{pid,jdbcType=DECIMAL}");
        }
        
        sql.WHERE("DEPTID = #{deptid,jdbcType=DECIMAL}");
